...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-soupx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9997&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-soupx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-soupx` can be installed with:

```
conda install r-soupx
```

It is possible to list all of the versions of `r-soupx` available on your platform with:
